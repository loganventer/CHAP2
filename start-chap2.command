...
DOCKER_COMPOSE_FILE="$SCRIPT_DIR/.deploy/linux-mac/docker-compose.yml"
...
cleanup_containers() {
    ...
    cd "$SCRIPT_DIR/.deploy/linux-mac"
...
main() {
    ...
    log_info "  cd $SCRIPT_DIR/.deploy/linux-mac && docker-compose down"
    echo ""
}
