...
try {
    ...
    Write-Host "   ✓ Qdrant accessible from host" -ForegroundColor Green
} catch {
    Write-Host "   ✗ Qdrant not accessible from host" -ForegroundColor Red
}
...
try {
    ...
    Write-Host "   ✓ Ollama accessible from host" -ForegroundColor Green
} catch {
    Write-Host "   ✗ Ollama not accessible from host" -ForegroundColor Red
}
...
try {
    ...
    Write-Host "   ✓ LangChain Service accessible from host" -ForegroundColor Green
} catch {
    Write-Host "   ✗ LangChain Service not accessible from host" -ForegroundColor Red
}
...
try {
    ...
    Write-Host "   ✓ CHAP2 API accessible from host" -ForegroundColor Green
} catch {
    Write-Host "   ✗ CHAP2 API not accessible from host" -ForegroundColor Red
}
...
try {
    ...
    Write-Host "   ✓ Web Portal accessible from host" -ForegroundColor Green
} catch {
    Write-Host "   ✗ Web Portal not accessible from host" -ForegroundColor Red
}
...
try {
    ...
    if ($searchResponse.StatusCode -eq 200) {
        Write-Host "   ✓ LangChain search endpoint working" -ForegroundColor Green
    } else {
        Write-Host "   ✗ LangChain search endpoint returned: $($searchResponse.StatusCode)" -ForegroundColor Red
    }
} catch {
    Write-Host "   ✗ LangChain search endpoint not working" -ForegroundColor Red
}
...
try {
    ...
    if ($webSearchResponse.StatusCode -eq 200) {
        Write-Host "   ✓ Web Portal search working" -ForegroundColor Green
    } else {
        Write-Host "   ✗ Web Portal search returned: $($webSearchResponse.StatusCode)" -ForegroundColor Red
    }
} catch {
    Write-Host "   ✗ Web Portal search not working" -ForegroundColor Red
}
