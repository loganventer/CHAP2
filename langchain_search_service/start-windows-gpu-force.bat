@echo off
echo ========================================
echo CHAP2 LangChain Search Service - Force GPU
echo ========================================
echo.
...
echo Starting deployment with FORCED GPU mode...
echo.

REM Execute the PowerShell script with ForceGpu parameter
powershell -ExecutionPolicy Bypass -File "start-windows-gpu-detection.ps1" -ForceGpu
